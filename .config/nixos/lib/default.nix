{ lib }:
# stolen from https://github.com/gvolpe/nix-config/blob/9cf395d695093074b77a234dd449c07fb4c07d09/lib/default.nix
# under apache licence, no changes as of inital commit
{
